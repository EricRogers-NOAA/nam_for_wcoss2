#!/bin/sh
#PBS -N nam_prdgen_tm00_f75
#PBS -l select=1:ncpus=8:mem=28GB
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_prdgen_12_tm00_f75.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_prdgen_12_tm00_f75.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
