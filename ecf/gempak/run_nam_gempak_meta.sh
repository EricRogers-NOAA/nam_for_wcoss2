#!/bin/sh
#PBS -N jnam_gempak_meta_18
#PBS -l select=1:ncpus=24:mem=28GB
#PBS -l walltime=02:30:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_gempak_meta_18.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_gempak_meta_18.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
