#!/bin/sh
#PBS -N nam_catchup_coldstart_sfcupdate_hawaii_12
#PBS -l select=1:ncpus=2:mem=8GB
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_coldstart_sfcupdate_hawaii_12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_coldstart_sfcupdate_hawaii_12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
