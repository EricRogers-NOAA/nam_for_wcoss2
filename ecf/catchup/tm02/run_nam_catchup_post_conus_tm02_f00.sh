#!/bin/sh
#PBS -N nam_nam_catchup_post_conus_tm02_f00_18
#PBS -l select=1:ncpus=28:mem=100GB
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_post_conus_tm02_f00_18
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_post_conus_tm02_f00_18
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
