#!/bin/sh
#PBS -N nam_catchup_forecast_tm03_18
#PBS -l place=vscatter:excl,select=14:ncpus=128
#PBS -l walltime=00:45:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_forecast_tm03_18.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_catchup_forecast_tm03_18.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -l hyper=true
