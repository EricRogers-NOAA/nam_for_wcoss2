#!/bin/sh
#PBS -N nam_analysis_alaska__12
#PBS -l place=vscatter:excl,select=11:ncpus=128:mpiprocs=16:ompthreads=8
#PBS -l walltime=00:20:00
#PBS -e /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_analysis_alaska__12.out
#PBS -o /lfs/h2/emc/lam/noscrub/Eric.Rogers/nam.v4.2.0/logs/nam_analysis_alaska__12.out
#PBS -q dev
#PBS -A NAM-DEV
#PBS -l debug=true
#PBS -V
